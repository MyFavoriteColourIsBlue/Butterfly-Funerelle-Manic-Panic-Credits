...
var credits = [
	[
		...
		"Intro music - ",
		"",
		"Lobby music - Lisa And The Devil (Main Titles)",
		"Chase music - 【旧アルカナ】鳥籠姫-トリカゴヒメ- ／since2009【Reboot】",
		" -- link: https://youtu.be/-OO1aLE6YCM?si=5gYcHo9RiaVP6Ofy"
	],[
		"Sound Effects",
		"Menu_focus - michael games",
		"Menu_focus - michael games" 
	],[
		"Testers",
		"ELvis Quach",
